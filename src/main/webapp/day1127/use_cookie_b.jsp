  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<%
					//web parameter 받기 : 이전페이지의 값을 받아서 사용 !!
					String name=request.getParameter("name");
					String age=request.getParameter("age");
					//1.쿠키생성
					Cookie ageCookie=new Cookie("age",name);
					Cookie nameCookie=new Cookie("naem",age);
					//2.생존시카설정'
					...
					<div class="counter">
						<span class="count"> 
						<strong><%= name %></strong>님 어서오고
						</span>
					</div>

					쿠키  <a href="use_cookie_c.jsp">이동</a>
				</div>
