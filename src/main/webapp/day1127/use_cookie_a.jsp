...
<link rel="shortcut icon"
	href="http://localhost:80/jsp_prj/common/images/favicon.ico">
...
<body>
		...
		<table>
			<tr>
				...
				<td rowspan="2"><input type="button" value="입력" id="btn"
					tabindex="3" class="btn btn-info" /></td>
			</tr>
			<tr>
	...
	<%}else{ 
		for(int i=0; i<cookieName.size(); i++){//쿠키가있음%>
		쿠키명: <%= cookieName.get(i) %><br>
		쿠키명: <%= cookieValue.get(i) %><br>
	<%
		} 
	%>
	<a href="use_cookie_c.jsp">쿠키삭제</a>
	<%
	}//end else 
	%>
	...
	<footer class="container">
		...
		<p>
			&copy; SIST class2. &middot; <a href="#">개인정보호정책</a> &middot; 개인정보관리
			책임자 님이셈
		</p>
	</footer>
	</main>
