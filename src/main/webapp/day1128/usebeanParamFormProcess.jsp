  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				//한정적인 자원을 동시사용할때 조회를 먼저 수행한 후다음 작업으로 진행한다.
				boolean idFlag=wms.searchId(pDTO.getId());
				if(idFlag){//다른사람이 아이디를 선점한경우
				%>
				...
				boolean addFlag=wms.addMember(pDTO,spVO.getKey());//한정적인 자원을 동시사용할때
				...
				주소 : <jsp:getProperty property="lang" name="pDTO"/><br>
