      ...
      <jsp:include page="../fragments/carousel.jsp"/>
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<%
					// 1. Attribute로 보낸 리스트 받기
					List<String> names=(List<String>)request.getAttribute("names");
					
					// 2. Param으로 보낸 이름, 나이 받기
					...
					<label>다음 중 가장 좋아하는 캐릭터는 ?</label><br> 
					<%
					// 3. 리스트 출력 (Null 체크 추가)
					if(names != null) {
					...
					%> 
						<%= i+1 %>. 
						<input type="checkbox" name="character" value="<%= names.get(i) %>"/>
						<%= names.get(i) %>&nbsp; 
					<% 
						} // end for
					} else {
						out.println("데이터가 넘어오지 않았습니다. a파일을 실행해주세요.");
					}
					%>
