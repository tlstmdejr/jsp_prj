      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
               ...
               %>
               EL 변수출력(el에서는 변수에 직접접근 불가)<br>
               메세지 : ${msg }<br>
                ${day }일
                <div>
                <!--el에서 scope객체명으로 변수를 사용 -->
                메세지 ${pageScope.todayMsg }<br>
                ...
                request.setAttribute("reqName2", "탄지로2");
                session.setAttribute("sesName3", "탄지로3");
                application.setAttribute("appName4", "탄지로4");
                //이름이같은경우
                pageContext.setAttribute("sName", "탄지로");//지역변수 // 이름이같을경우 지역변수의 이름이 우선
                ...
                <hr>
                el에서 사용<br>
              <!-- pageScope scope부분을 생략하고 pagename처럼 이부분만써서 불러오는걸 권장한다 -->
                pageScope : ${ pageScope.pageName }(${pageName })<br>
                requestScope : ${requestScope.reqName2}(${reqName2 })<br>
                sesoionScope : ${sessionScope.sesName3 }(${sesName3 })<br>
                applicationoScope : ${applicationScope.appName4 }(${appName4 })
                <br>
                <!-- scope객체가 이름이같다면 page>request>session>application 
                순서로 접근하여 사용 -->
                ${sName}<br>
                ${requestScope.sName}
