<%@page import="day1119.ImgDTO"%>
<%@page import="java.util.List"%>
<%@page import="day1119.DataService"%>
...
<script src="http://192.168.10.83/jsp_prj/common/js/color-modes.js"></script>
<!-- bootstrap CDN 시작 -->
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script>

<meta name="theme-color" content="#712cf9">
<link href="http://192.168.10.83/jsp_prj/common/css/carousel.css" rel="stylesheet">
<style>
.bd-placeholder-img {
   font-size: 1.125rem;
   text-anchor: middle;
...
<body>
  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         List<ImgDTO> list=ds.searchImg();
         for(ImgDTO iDTO : list){ %>
         <hr class="featurette-divider">
         <div class="row featurette">
            <div class="col-md-7">
            <a href="<%= iDTO.getUrl() %>" target="blank">
            	<img src="http://localhost:8081/jsp_prj/common/images/<%= iDTO.getImg()%>">
               코딩영역
               </a>
            </div>            
         </div>
         ...
         <div class="row featurette">
            <div class="col-md-7">
            	<img src="http://localhost:8081/jsp_prj/common/images/james.png">
               코딩영역
               </a>
            </div>            
         </div>
