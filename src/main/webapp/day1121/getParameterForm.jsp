...
/* 테이블 디자인을 위해 ID 유지 */
#joinTable{ border-top:4px solid #888888; border-spacing: 0px }
...
<div id="joinFrmDiv">
	<form name="joinFrm" id="joinFrm" method="GET" action="getParameterFormProcess.jsp">
	...
	<table id="joinTable">
		...
		<tr>
			...
			<td class="input"><input type="date" name="birth" class="inputBox" id="birth" value="2025-11-06"/></td>
		</tr>
		
		<tr>
			<td class="title"><label><span class="star">*</span>이메일</label></td>
			<td class="input"><input type="text" name="email" style="width: 250px" class="inputBox"  value="min"/>@ 
			<input type="text" list="domain"  name="domain" class="inputBox" value="hanmail.net">
			<input type="checkbox" name="emailRecv" value="수신">수신
				<datalist id="domain">
		...
		<tr>
			<td colspan="2" style="text-align: center">
				...
				<input type="button" value="get방식값 전송" class="btnBox" id="btnGet"/>
			</td>
		</tr>
	</table>
	</form>
	...
	<table id="joinTable">
		...
		<tr>
			<td colspan="2" style="text-align: center">
				<input type="hidden" name="code" value="U3881">
				<input type="button" value="POsT방식값 전송" class="btnBox" id="btnPost"/>
			</td>
		</tr>
	</table>
	</form>
