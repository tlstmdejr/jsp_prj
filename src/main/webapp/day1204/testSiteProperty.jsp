...
<link rel="shortcut icon" href="${siteProperty.protocol}${SiteProperty.server_name}${SiteProperty.context_root}/common/images/favicon.ico">
   ...
   <main>
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
            <a href="${CommonURL}/day1204/testSiteProperty.jsp">요청</a>
               <%= SiteProperty.spVO %>>
            </div>
         </div>
         <hr class="featurette-divider">
