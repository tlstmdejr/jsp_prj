...
function paramQueryString(){
	//queryString 형식으로 web parameter전송하기
	//htmlformcontrol의 name속성의이름과 상관없이 parameter명을만들수있다
	...
	$.ajax({
		...
		dataType:"JSON",
		error:function(xhr){
			$("#output").html(xhr.statues+"/"+xhr.statusText);
		},
...
function paramJSON(){
	...
	//jsonobject형식으로 web parameter 전송
	var param={na : $("#name").val(), age:$("#age").val()}
	...
	$.ajax({
		...
		dataType:"JSON",
		error:function(xhr){
			console.log(xhr.statues+"/"+xhr.statusText);
		},
		success:function(jsonObj){
			//parsing
   ...
   <main>
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
               <strong>ajax parmeter요청</strong><br>
				<label>이름</label>               
				<input type="text" name="name" id="name"><br>			
				<label>나이</label>               
				<input type="text" age="age" id="age"><br>
				<button id="btnQs" class="btn btn-success">queryString 방식</button><br>
				<button id="btnJson" class="btn btn-success">jsonobject 방식</button><br>
			</div>
			<div id="output"></div>
			<div id="output2">
