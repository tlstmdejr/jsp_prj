...
function idDup(id){
	...
	$.ajax({
		...
		dataType:"JSON",
		error:function(xhr){
			alert("서버에서 문제가 발생하엿ㅆ습니다")
			console.log(xhr.status);
		},
		success: function(jsonObj){
			$("#idWarning").html(jsonObj.idResult?"사용가능합니다":"이미사용중");
		}	
	});
  ...
  ================================================== -->
	...
	<table id="joinFrm">
		<tr>
			...
			<td class="input"><input type="text" class="inputBox" name="id" id="id"/>
			<div id="idWarning">증복확인
			</div>
			</td>
		</tr>
