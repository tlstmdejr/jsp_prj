...
<title>JSP템플릿</title>
<link rel="shortcut icon" href="http://localhost:8081/jsp_prj/common/images/favicon.ico">
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
             ...
             Date date=(Date)session.getAttribute("connectTime");
             //1.직접호출하면 세션에 설정된 값이없음으로 null이나온다
             //(비정상적인 요청=>페이지이동)
             //2.설정한 interval시간내에 요청이없으면 세션의값이 삭제된다(null반환)
             //정상적인요청이였으나 딴짓을오래했음(다른사람일 수 도 있음)
             if(name==null){
