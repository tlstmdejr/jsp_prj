         ...
         <div class="row featurette">
            <div class="col-md-7">
               ...
               <!--
				...
				-->
		<form action="uploadFrmProcess.jsp" method="post" enctype="multipart/form-data" id="frm" action="fup.cgi">
		<label>업로더</label>
...
<!-- 		<input type="file" accept=".jpg, .png, .gif, .bmp" name="upfile" id="upfile" style="display:none" /><br>
 -->		
		...
		<input type="button" value="업로드" class="btn btn-success bnt-sm" id="btnUpload"/><br>
		</form>
            </div>
         </div>
         <hr class="featurette-divider">
