...
<div id="wrap">
	...
	<label>관심언어</label>
	<input type="checkbox" name="lange" value="java"/> 자바
	<input type="checkbox" name="lange" value="C"/> C/C++
	<input type="checkbox" name="lange" value="visual basic"/>비주얼베이직
	<input type="checkbox" name="lange" value="PyThon"/>파이썬
	<input type="checkbox" name="lange" value="PHP"/>PHP
	<input type="checkbox" name="lange" value="JSP"/>JSP
	<br>
